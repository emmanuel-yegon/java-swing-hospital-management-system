...
public class hospitalInformation extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("A hospital Management System(HMS) is an element of health  informatics  that focuses \nmainly on the administrational needs of hospitals. ...These systems enhance the ability\nof health care professionals to coordinate care by providing  a patients's health \ninformation and visit history at the place and time that is needed.\n");
        jScrollPane1.setViewportView(jTextArea1);

        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 290, 769, 130));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(645, 458, -1, -1));

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/add new patient background.jpg"))); // NOI18N
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, -60, -1, 620));
